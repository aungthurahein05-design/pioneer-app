...
<head>
    ...
    <style>
        ...
        .card:hover {
            ...
            background-color: rgba(152, 216, 219, 0.16);
        ...
        img {
            ...
            margin-bottom: 1rem;
            border-radius: 10px;
            background-color: rgba(152, 216, 219, 0.1);
        }
...
@endif
            ...
            <div class="row g-4 text-center">
                <div class="col-md-4">
                    <div class="card p-4 h-100">
                        ...
                        <img src="{{ asset('images/school1.jpg') }}" alt="school">
        ...
        <div class="container">
            ...
            <div class="container mt-4">
                <div class="row g-4">
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <img src="{{ asset('images/gallery2.jpg') }}" class="card-img-top" alt="Classroom">
                            <div class="card-body">
                                <h5 class="card-title">Smart Classroom</h5>
                                <p class="card-text">Modern teaching tools help students learn better and interactively.</p>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <img src="{{ asset('images/gallery3.jpg') }}" class="card-img-top" alt="Sports Day">
                            <div class="card-body">
                                <h5 class="card-title">Sports Day</h5>
                                <p class="card-text">Our students enjoying a day filled with energy and friendly competition.</p>
                            </div>
            ...
            <div class="container mt-4">
                <div class="row g-4">
                    <div class="col-md-4">
                        <div class="card h-100 border-0 shadow-sm">
                            <img src="{{ asset('images/gallery1.jpg') }}" class="card-img-top" alt="Student Activity">
                            <div class="card-body">
                                <h5 class="card-title">Science Fair</h5>
                                <p class="card-text">Our students showcasing their innovation and creativity during the annual science fair.</p>
                            </div>
    ...
    {{-- Footer --}}
    <footer>
        &copy; {{ date('Y') }} Pioneer Private School. All rights reserved.
    </footer>
